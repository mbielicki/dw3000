...
#define POLL_TX_TO_RESP_RX_DLY_UUS (200 + CPU_PROCESSING_TIME)//(300 + CPU_PROCESSING_TIME)
...
#define RESP_RX_TO_FINAL_TX_DLY_UUS (0 + CPU_PROCESSING_TIME)//(300 + CPU_PROCESSING_TIME)
